...
public class Message implements Serializable
{
	...
	public char [] blockBombXY = new char[2]; //x, y coordinates of the block on the opponent's board ot be bombed; this is for the MSG_RESPONSE_PLAY message
	//private int [] blockBombY = new int[1];
	...
	public Message()
	{
		...
		this.Ftable = new BattleShipTable();
	}
